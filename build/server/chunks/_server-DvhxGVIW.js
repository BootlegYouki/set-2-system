...
import { c as createDocumentRequestNotification } from './notification-helper-3WedpjE4.js';
  ...
  try {
    ...
    const formattedRequests = documentRequests.map((request2) => {
      const baseRequest = {
        ...
        adminName: request2.admin_name,
        completedByAdmin: request2.completed_by_admin,
...
//# sourceMappingURL=_server-DvhxGVIW.js.map
